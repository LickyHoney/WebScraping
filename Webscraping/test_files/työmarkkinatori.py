...
def scrape_työmarkkinatori():
    ...
    for keyword in keywords:
        ...
        url = f'https://tyomarkkinatori.fi/en/personal-customers/vacancies/?q={formatted_keyword}'
        print(url)
        ...
        #job_listings = soup.find("div", class_="sg12141__sc-1mg984k-0 fSyLLn tmt-haku-search-results-list")
        job_listing = soup.find_all('div', class_='sg12141__sc-1nbk2wl-0 hJEkg')
        #job_listings = soup.find_all("div", class_="sg12141__sc-1nbk2wl-0")
    ...
    with open("job_englishjobs_data.json", "w") as outfile:
